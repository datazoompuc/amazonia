...
layout: default
lang: pt
title: "Séries Temporais de Exportação por País"
description: "Comércio Exterior na Amazônia Legal: Valor da exportação de bens por país de destino e categoria de produto (SEC)"
---
<br><br>
<!-- titulo da viz sem aspas-->
<h1 class="title-about" style="max-width: 1000px"> Séries Temporais do Valor Exportado pela Amazônia Legal por País de Destino e Categoria de Produto</h1>
<br>
<!-- instruções sobre o gráfico-->
<p class="text-center">
  Em nosso gráfico dinâmico, selecione uma categoria de bens exportados e visualize o total da Amazônia Legal ou escolha os países de destino de interesse. Valores são reportados em US$.
</p>
<br>
<!-- link do shinyapps -->
<div class="container-fluid p-0">
  <iframe
    src="https://datazoom.shinyapps.io/app_ts_comex_exp_pais_sec/"
    width="100%"
    height="800"
    frameborder="0"
    allowfullscreen
